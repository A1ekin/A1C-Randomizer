...
- При наведении на активный (центральный) элемент через 0.5 секунд всплывает полный текст строки (на случай, если вся строка не влезает в интерфейс программы)
...
- Внизу окна есть ссылка на сайт A1C Production: [http://a1cprod.ru](http://a1cprod.ru)
    ...
    <td>
      <img src="img/screen-3.png" alt="Скриншот" width="350">
    </td>
